...
/**
 * White pie with falling alpha over dark dest reads as a grey (or, if the
 * dest colour was baked into the PNG, a wrong-coat) rim. Over covered dest,
 * mix RGB with the dest colour and stay opaque. Over void, source-over.
 */
